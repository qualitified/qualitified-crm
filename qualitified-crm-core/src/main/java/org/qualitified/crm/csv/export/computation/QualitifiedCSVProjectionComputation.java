...
import org.qualitified.crm.csv.export.action.QualitifiedCSVExportAction;
 ...
 * @since 10.3
 */
public class QualitifiedCSVProjectionComputation extends AbstractBulkComputation {

    private static final Logger log = LogManager.getLogger(QualitifiedCSVProjectionComputation.class);
    ...
    public QualitifiedCSVProjectionComputation() {
        super(QualitifiedCSVExportAction.ACTION_NAME);
    }
