                  ...
                  <tr>
                    <td style="background-color:#fff;padding:8px 20px;"><br />
                      <p style="margin:0;font-size:14px;color: black;">
                        Vous avez reçu un nouveau message pour le sinistre <strong>${Document['dc:title']}</strong>:<br /><br />
                      </p>

                      <div style="background-color:#f7f7f7;padding: 8px 39px;width: fit-content;margin-left: 46px;font-size: 14px;color: black;border-radius: 2em;">
                        <div style="color:grey;">${Document['custom:systemField1']} </div>
                      </div>
                      <br />
                  ...
                  <tr>
                    <td style="background-color:#f7f7f7;border-top:1px dashed #e9ecef;text-align:center;padding:8px 20px;">
                      <div style="font-size:12px;color:#bbb;">
                        Vous avez re&ccedil;u cette notification parce que vous &ecirc;tes abonn&eacute; &agrave; &laquo; notification de chat &raquo; sur ce document ou sur l'un de ses parents.</div>
                    </td>
                  </tr>
                </tbody>
              </table>
