                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;"><br/>
                        ...
                        A <strong>workflow</strong>was started on <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docUrl}">${htmlEscape(docTitle)}</a>.
                        </p><br/>
                        <table cellpadding="6" cellspacing="0" style="border:none;border-collapse:collapse;font-size:13px;">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td style="border:1px solid #eee;color:#000;font-size:13px;"><a href="${docUrl}" style="color:#22aee8;text-decoration:underline;word-wrap:break-word!important;">${htmlEscape(docId)}</a>
                              </td>
                            </tr>
                          </tbody>
                        </table><br/>
