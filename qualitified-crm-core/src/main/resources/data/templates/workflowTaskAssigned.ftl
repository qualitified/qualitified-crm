                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;"><br/>
                        ...
                        A task on the document <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docUrl}">${htmlEscape(docTitle)}</a> was <strong>assigned to you</strong> or to a group you belong to.
                        </p><br/>
