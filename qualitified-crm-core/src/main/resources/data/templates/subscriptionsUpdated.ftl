                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;"><br/>
                        <p style="font-size:14px;"><strong> ${htmlEscape(principalAuthor.firstName)} ${htmlEscape(principalAuthor.lastName)} (${author})</strong> has subscribed you to ${notifName} on <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word!important;" href="${docUrl}">${htmlEscape(docTitle)}</a>.
                        </p><br/>
                        <p>
