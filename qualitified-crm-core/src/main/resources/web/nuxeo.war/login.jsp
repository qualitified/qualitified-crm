...
String registerUrl = Framework.getProperty("ccm.register.url");
...
String loginButtonBackgroundColor = LoginScreenHelper.getValueWithDefault(screenConfig.getLoginButtonBackgroundColor(), "#ff7f00");
...
boolean displayMobileBanner = false;
%>
  ...
  <section>
    <div class="main">
      ...
      <form method="post" action="startup" autocomplete="<%= fieldAutocomplete %>">
        ...
        <% if (registerUrl != null) {%>
        <a href="<%=registerUrl%>" title="Sign Up">No Access Yet? Sign Up!</a>
        <%}%>
